...
const CaptureScreen = ({ navigate, gymId }) => {
  ...
  return (
    <div className="screen-container" style={{ backgroundColor: '#000', color: '#fff', justifyContent: 'center' }}>
      ...
      {/* Results Screen */}
      {step >= 5 && (
        <div className="gb-window" style={{ width: '90%', margin: '0 auto', color: '#333' }}>
           {step === 5 ? (
             <>
